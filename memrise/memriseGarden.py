...
def main():
    while(True): 
        time.sleep(random.uniform(1, 4)) #makes it not sus
        #end================================================================================================================================
        try: 
...
if __name__ == '__main__':
    for i in range(10):
        ...
        website='https://www.memrise.com/course/5572813/francais-3/7/garden/learn/?source_element=level_details_session&source_screen=level_details'
